...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative w-screen left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] min-h-[55vh] md:min-h-[70vh] flex items-center pt-28 md:pt-32 pb-16"
    >
      <div
        className="absolute inset-0 bg-cover bg-center"
        style={{ backgroundImage: "url('/images/other images/banner.jpg')" }}
        aria-hidden="true"
      />
      <div className="absolute inset-0 bg-black/45" aria-hidden="true" />
      <div className="relative z-10 w-full">
        <div className="max-w-6xl mx-auto px-6 lg:px-0">
          <div className="max-w-2xl space-y-8 text-left bg-white/15 backdrop-blur-md border border-white/20 rounded-3xl px-8 py-10 shadow-xl lg:-ml-72">
